      ...
      >
        <div className="carousel-inner" id="carousel">
          ...
          <div className="carousel-item">
            <img
              src="https://images.unsplash.com/photo-1550547660-d9450f859349?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8YnVyZ2VyfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
              className="d-block w-100"
              alt="..."
              style={{ filter: "brightness(30%)" }}
            />
          ...
          <div className="carousel-item">
            <img
              src="https://images.unsplash.com/photo-1650977599122-d20a4b52718f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8bW9tb3N8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
              className="d-block w-100"
              alt="..."
              style={{ filter: "brightness(30%)" }}
            />
          ...
          return (
            <div className="m-3 row">
              ...
              {items
                .filter(
                  (item_values) =>
                    item_values.CategoryName == values.CategoryName &&
                    item_values.name
                      .toLowerCase()
                ...
                .map((item_values) => {
                  return (
                    <div className="col-12 col-md-6 col-lg-3">
                      <Card
                        _id={item_values._id}
                        CategoryName={item_values.CategoryName}
